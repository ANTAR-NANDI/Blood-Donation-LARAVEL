        ...
        <div class="container">
            <div class="row">
                ...
                <div class="footer-widget">
                    ...
                    <ul class="list-links">
                        <li><a href="{{ URL::to('Requestor/home') }}">Search Donors</a></li>
                        <li><a href="{{ URL::to('Requestor/about') }}">About Us</a></li>
                        ...
                        <li><a href="{{ URL::to('Requestor/request') }}">Request Blood</a></li>
                        <li><a href="{{ URL::to('Requestor/tips') }}">Blood Tips</a></li>
                        <li><a href="{{ URL::to('Requestor/privacy') }}">Privacy Policy</a></li>
