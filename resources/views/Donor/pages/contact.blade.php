                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="contact-map row">
                            ...
                            <form class="form-horizontal" method="post" action="{{URL::to('contactstore')}}" id="contact">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="control-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="" aria-describedby="basic-addon1" rel="tooltip" name="name" id="cname" value=""> </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="mobile" id="number" rel="tooltip" placeholder="" value=""> </div>
                                        </div>
                                        <div class="control-group">
                                            <label>City </label>
                                            <div class="input-group">
                            ...
                            <option value="Kishoreganj">Kishoreganj</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="control-group width-s">
                                            <label>Message *</label>
                                            <div class="input-group">
                                                <textarea style="height:100px" type="textarea" class="form-control" rel="tooltip" name="message" id="message1" placeholder="" value=""></textarea>
                                            </div>
                                        </div>
