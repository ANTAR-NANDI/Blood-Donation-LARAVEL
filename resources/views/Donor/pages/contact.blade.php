                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="contact-map row">
                            ...
                            <form class="form-horizontal" method="post" action="https://www.bloodbankindia.net/contact_us/contact_us_action" id="contact">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="control-group">
                                            <label>Full Name *</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="" aria-describedby="basic-addon1" rel="tooltip" name="cname" id="cname" value=""> </div>
                                        </div>
                                        <div class="control-group">
                                            <label>Email ID * </label>
                                            <div class="input-group">
                                                <input type="email" class="form-control" placeholder="" rel="tooltip" name="email" id="email" value=""> </div>
                                        </div>
                                        <div class="control-group">
                                            <label>Mobile No </label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="number" id="number" rel="tooltip" placeholder="" value=""> </div>
                                        </div>
                                        <div class="control-group">
                                            <label>City </label>
                                            <div class="input-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="control-group width-s">
                                            <label>Message *</label>
                                            <div class="input-group">
                                                <textarea style="height:100px" type="textarea" class="form-control" rel="tooltip" name="message1" id="message1" placeholder="" value=""></textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <button type="submit" class="btn btn-danger btn-bbi">Send</button> <span style="margin-left: 15px;" class="required-span"><sup>*</sup>fields are required</span>
                                        <br/> </div>
                                </div>
                            </form>
                        </div>
